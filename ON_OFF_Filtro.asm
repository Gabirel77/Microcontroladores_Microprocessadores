...
RES_VECT  CODE    0x0000            ; processor reset vector
    ...
    BCF	    JA_LI4		    ;JA_LI=0
    MOVLW   V_FILTRO		    ;W=50
    MOVWF   FILTRO1		    ;FILTRO =50
    MOVWF   FILTRO2		    ;FILTRO =50
    MOVWF   FILTRO3		    ;FILTRO =50
    MOVWF   FILTRO4		    ;FILTRO =50
LACO_PRINCIPAL
    BTFSC   BOTAO1		    ;testa se o botao1 esta pressionado
    GOTO    NAO_PRESS1		    ;se BOTAO nao pressionado, pule para NAO_PRESS
    BTFSC   JA_LI1		    ;se o botao esta pressionado, testa se JA_LI =0
    GOTO    TESTE2		    ;se JA_LI =1, pule para LACO_PRINCIPAL
    DECFSZ  FILTRO1,F		    ;decrementa o filtro e testa se zerou
    GOTO    TESTE2		    ;se FILTRO>0, pule para LACO_PRINCIPAL 
    ...
    GOTO    TESTE2		    ;pule para LACO_PRINCIPAL
...
TESTE2
    ...
    GOTO    NAO_PRESS2		    ;se BOTAO nao pressionado, pule para NAO_PRESS
    BTFSC   JA_LI2		    ;se o botao esta pressionado, testa se JA_LI =0
    GOTO    TESTE3		    ;se JA_LI =1, pule para LACO_PRINCIPAL
    DECFSZ  FILTRO2,F		    ;decrementa o filtro e testa se zerou
    GOTO    TESTE3		    ;se FILTRO>0, pule para LACO_PRINCIPAL 
    ...
    GOTO    TESTE3		    ;pule para LACO_PRINCIPAL
TESTE3
    BTFSC   BOTAO3		    ;testa se o botao1 esta pressionado
    GOTO    NAO_PRESS3		    ;se BOTAO nao pressionado, pule para NAO_PRESS
    BTFSC   JA_LI3		    ;se o botao esta pressionado, testa se JA_LI =0
    GOTO    TESTE4		    ;se JA_LI =1, pule para LACO_PRINCIPAL
    DECFSZ  FILTRO3,F		    ;decrementa o filtro e testa se zerou
    GOTO    TESTE4		    ;se FILTRO>0, pule para LACO_PRINCIPAL 
    ...
    GOTO    TESTE4		    ;pule para LACO_PRINCIPAL
TESTE4
    BTFSC   BOTAO4		    ;testa se o botao1 esta pressionado
    GOTO    NAO_PRESS4		    ;se BOTAO nao pressionado, pule para NAO_PRESS
    BTFSC   JA_LI4		    ;se o botao esta pressionado, testa se JA_LI =0
    GOTO    LACO_PRINCIPAL	    ;se JA_LI =1, pule para LACO_PRINCIPAL
    DECFSZ  FILTRO4,F		    ;decrementa o filtro e testa se zerou
    GOTO    LACO_PRINCIPAL	    ;se FILTRO>0, pule para LACO_PRINCIPAL 
